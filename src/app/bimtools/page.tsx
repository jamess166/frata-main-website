...
const BIMtoolsPage: FC = () => {
  ...
  const freeFeatures = [
    t('featureRenumbering'),
    t('featureSheetManager'),
  ]

  const proFeatures = [
    ...freeFeatures,
    t('featureExportImport'),
    t('featureFamilyManager'),
    t('featureClashSync'),
    t('featureApiAccess'),
  ...
  return (
    <div className="bg-background min-h-screen">
      <main className="py-16 sm:py-24 container mx-auto px-4 sm:px-6 lg:px-8">
