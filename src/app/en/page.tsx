      ...
      <section id="services" className="container mx-auto px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-2">
          {services.map((service) => (
            <Card key={service.title} className="group rounded-2xl border-border/70 bg-card/75 shadow-sm transition-all hover:-translate-y-1 hover:border-primary/35 hover:shadow-xl">
              <CardHeader>
      ...
      <section className="border-y bg-secondary/40">
        <div className="container mx-auto grid gap-10 px-4 py-20 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:py-24">
          ...
          <div className="space-y-4">
            ...
            <Button asChild size="lg" className="mt-2 rounded-md px-7">
