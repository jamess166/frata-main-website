          ...
          <p className="mt-4 text-xs font-medium uppercase tracking-[0.14em] text-muted-foreground">
            {manual.commerce.isPremium ? (
              <>
                ...
                {manual.commerce.trialDays ? ` · ${manual.commerce.trialDays}-day trial` : null}
              </>
            ) : (
              "Free"
            )}
          ...
          <div className="mt-8 space-y-3">
            {manual.commerce.isPremium ? (
              <p className="text-sm leading-7 text-muted-foreground">
                Get this add-in and every premium add-in for{" "}
                <strong className="text-foreground">USD 20/month</strong> or{" "}
                <strong className="text-foreground">USD 100/year</strong>.
              </p>
            ) : null}
        ...
        <article className="min-w-0">
          ...
          {manual.media.images.length > 0 ? (
            <section className="mt-14 border-t border-border pt-10">
              <h2 className="font-headline text-2xl font-bold tracking-tight text-foreground">Gallery</h2>
