...
export const translations = {
  en: {
    ...
    service4Detail: "We provide high-level-of-detail (LOD 400) models ready for fabrication, specializing in reinforced concrete structures. Our expertise in 3D rebar detailing ensures that every piece is modeled with precision, facilitating automated fabrication processes and seamless on-site assembly. This service reduces waste, improves accuracy, and accelerates the construction timeline by ensuring that components are manufactured correctly the first time.\n\n### Included 3D Detailing Services:\n- **3D Rebar Modeling:** Creation of accurate and clash-free 3D models of reinforcement.\n- **Rebar Shop Drawings:** Generation of clear, detailed drawings for fabrication.\n- **Bar Bending Schedules (BBS):** Precise schedules for efficient bar bending and management.\n- **As-Built Modeling:** Updating models to reflect on-site changes.\n\n### Key Benefits:\n- **Enhanced Accuracy:** Eliminates errors and rework through precise 3D modeling.\n- **Improved Visualization:** Allows all stakeholders to understand complex reinforcement details.\n- **Efficient Material Management:** Optimizes rebar consumption and reduces waste.\n- **Streamlined Construction:** Simplifies on-site assembly with clear, coordinated plans.\n\n### Our Process:\n1.  **Requirement Analysis:** Understanding project specifications and standards.\n2.  **3D Modeling:** Creating the detailed rebar model in a collaborative environment.\n3.  **Clash Detection:** Ensuring perfect coordination with other structural elements.\n4.  **Deliverables Generation:** Producing shop drawings and bar bending schedules.\n5.  **Quality Assurance:** Rigorous review to guarantee precision and compliance.",
  ...
  es: {
    ...
    service4Detail: "Proporcionamos modelos de alto nivel de detalle (LOD 400) listos para su fabricación, especializándonos en estructuras de concreto armado. Nuestra experiencia en el detallado 3D de armaduras garantiza que cada pieza se modele con precisión, facilitando procesos de fabricación automatizados y un ensamblaje en obra sin contratiempos. Este servicio reduce el desperdicio, mejora la precisión y acelera los plazos de construcción al asegurar que los componentes se fabriquen correctamente desde el principio.\n\n### Servicios de Detallado 3D Incluidos:\n- **Modelado 3D de Armaduras:** Creación de modelos 3D precisos y sin interferencias del refuerzo.\n- **Planos de Taller de Armaduras:** Generación de planos claros y detallados para la fabricación.\n- **Listas de Doblado de Barras (BBS):** Listados precisos para un doblado y gestión eficientes de las barras.\n- **Modelado As-Built:** Actualización de los modelos para reflejar los cambios realizados en obra.\n\n### Beneficios Clave:\n- **Precisión Mejorada:** Elimina errores y retrabajos gracias a un modelado 3D preciso.\n- **Visualización Optimizada:** Permite a todos los interesados comprender detalles complejos de la armadura.\n- **Gestión Eficiente de Materiales:** Optimiza el consumo de acero y reduce el desperdicio.\n- **Construcción Simplificada:** Facilita el montaje en obra con planos claros y coordinados.\n\n### Nuestro Proceso:\n1.  **Análisis de Requisitos:** Comprensión de las especificaciones y normativas del proyecto.\n2.  **Modelado 3D:** Creación del modelo detallado de armaduras en un entorno colaborativo.\n3.  **Detección de Interferencias:** Asegurando una coordinación perfecta con otros elementos estructurales.\n4.  **Generación de Entregables:** Producción de planos de taller y listas de doblado de barras.\n5.  **Control de Calidad:** Revisión rigurosa para garantizar la precisión y el cumplimiento.",
