...
export const translations = {
  en: {
    ...
    manualSearchViewDesc: 'Quickly find and navigate to views, sheets, schedules, and legends within your Revit project.',
    manualSearchViewStep1: 'Enter a keyword in the search box.',
    manualSearchViewStep2: 'Results will appear instantly as you type.',
    manualSearchViewStep3: 'Double-click an item to open it.',
  ...
  es: {
    ...
    manualSearchViewDesc: 'Encuentra y navega rápidamente a vistas, planos, tablas de planificación y leyendas dentro de tu proyecto de Revit.',
    manualSearchViewStep1: 'Introduce una palabra clave en el cuadro de búsqueda.',
    manualSearchViewStep2: 'Los resultados aparecerán instantáneamente mientras escribes.',
    manualSearchViewStep3: 'Haz doble clic en un elemento para abrirlo.',
