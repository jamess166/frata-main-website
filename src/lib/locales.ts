...
export const translations = {
  en: {
    ...
    featureRenumbering: 'Element Renumbering Tool',
    featureSheetManager: 'Sheet Manager Lite',
    featureExportImport: 'Advanced Export/Import',
    featureFamilyManager: 'Family Manager',
    featureClashSync: 'Cloud Clash Sync',
  ...
  es: {
    ...
    featureRenumbering: 'Herramienta de Renumeración de Elementos',
    featureSheetManager: 'Gestor de Planos Lite',
    featureExportImport: 'Exportación/Importación Avanzada',
    featureFamilyManager: 'Gestor de Familias',
    featureClashSync: 'Sincronización de Interferencias en la Nube',
    featureApiAccess: 'Acceso API para Scripts Personalizados',
